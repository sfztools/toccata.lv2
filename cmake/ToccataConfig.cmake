...
if (NOT TOCCATA_SYSTEM_PROCESSOR)
    if(MSVC)
        set(TOCCATA_SYSTEM_PROCESSOR "${MSVC_CXX_ARCHITECTURE_ID}")
    else()
        set(TOCCATA_SYSTEM_PROCESSOR "${CMAKE_SYSTEM_PROCESSOR}")
    endif()
endif()
...
if (CMAKE_CXX_COMPILER_ID MATCHES "GNU|Clang")
    ...
    if (TOCCATA_SYSTEM_PROCESSOR MATCHES "^(i.86|x86_64)$")
